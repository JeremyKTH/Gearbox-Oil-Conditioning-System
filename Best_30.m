T_train = readtable('C:\Users\jerem\Documents\Python Scripts\Scania\Test_Data\Training_Data\D_47414_train.csv');
T_train.Properties.VariableNames = {'OTSV1', 'TV12', 'TV11'};
T_test = readtable('C:\Users\jerem\Documents\Python Scripts\Scania\Test_Data\Testing_Data\D_47414_test.csv');
...
opt.SearchOptions.MaxIterations = 1000;
opt.SearchOptions.Tolerance = 1e-5;
sysBJ = bj(data_train, [2 1 1 1 1], opt, 'IODelay', 20) % -----------------
