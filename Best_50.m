T_train = readtable('C:\Users\jerem\Documents\Python Scripts\Scania\Test_Data\Training_Data\D_49404_train.csv');
T_train.Properties.VariableNames = {'OTSV1', 'TV12', 'TV11', 'OTGT1'};
T_test = readtable('C:\Users\jerem\Documents\Python Scripts\Scania\Test_Data\Testing_Data\D_49404_test.csv');
...
sysARMAX = armax(data_train, [4 1 1 1], opt); %----------------------------
...
opt.SearchOptions.MaxIterations = 1000;
opt.SearchOptions.Tolerance = 1e-5;
sysBJ = bj(data_test, [1 1 1 4 1], opt, 'IODelay', 20); % -----------------
